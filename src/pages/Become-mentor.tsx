...
export default function Become-mentor() {
  ...
  useEffect(() => {
    if (!user) return
    supabase.from('mentors').select('*').limit(20)
    ...
    <div className="min-h-screen bg-gray-950 text-white">
      ...
      <header className="border-b border-gray-800 px-6 py-4 flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="font-bold text-white text-sm">IT-S-Mentor</h1>
            <p className="text-xs text-gray-500">Become-mentor</p>
          </div>
        </div>
        <div className="flex items-center gap-3">
      ...
      <main className="max-w-5xl mx-auto px-6 py-8">
        <div className="flex items-center justify-between mb-6">
          <h2 className="text-xl font-bold">Become-mentor</h2>
